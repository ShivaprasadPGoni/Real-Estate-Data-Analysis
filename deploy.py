...
df = pd.read_csv("C:\\Users\\USER\\Shivaprasad\\ExcelR Project\\Property_info1 (1).csv")
...
if analysis=='Data Analysis & Visualization':
    ...
    st.image(Image.open(os.path.join("C:\\Users\\USER\\Shivaprasad\\ExcelR Project\\image.jfif")))
    st.write('')
...
#show dimensions 
    ...
    pickle_in = open("C:\\Users\\USER\\Shivaprasad\\ExcelR Project\\houseE.pkl",'rb')
    ...
    def main():
        ...
        """
        st.image(Image.open(os.path.join("C:\\Users\\USER\\Shivaprasad\\ExcelR Project\\eda.jfif")))
